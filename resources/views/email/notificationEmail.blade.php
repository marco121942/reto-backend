...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" yahoo="fix">
    ...
    <div class="ui-sortable" id="sort_them">
        <!-- Notification 1  -->
        <div style="display: none" id="element_0014548333594575524"></div><!-- End Notification 1 -->

        <!-- Notification 2  -->
        <div style="display: none" id="element_032002251874655485"></div><!-- End Notification 2 -->

        <!-- Notification 3  -->
        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"
            bgcolor="#e3e6ed" style="background-color: rgb(242, 244, 249);">
            <tr>
                <td align="center"
                    style="background-image: url('images/not3_bg_image.jpg'); -webkit-background-size: cover; background-size: cover; background-color: rgb(242, 244, 249); background-position: center center; background-repeat: no-repeat;"
                    id="not3ChangeBG">
                            ...
                            <td width="100%" height="100" align="center">
                                ...
                                <div class="sortable_inner ui-sortable">
                                    ...
                                    <table width="400" border="0" cellpadding="0" cellspacing="0" align="center"
                                        ...
                                        <tr>
                                            <td width="100%"
                                                style="border-top-left-radius: 6px; border-top-right-radius: 6px; border-bottom-right-radius: 6px; border-bottom-left-radius: 6px; -webkit-box-shadow: rgba(0, 0, 0, 0.74902) 0px 0px 6px 0px; box-shadow: rgba(0, 0, 0, 0.0980392) 0px 0px 6px 0px; background-color: rgb(255, 255, 255);"
                                                bgcolor="#ffffff">

                                                <!-- Start Top -->
                                                <table width="400" border="0" cellpadding="0" cellspacing="0"
                                                    align="center" class="mobile" bgcolor="#00d2c2"
                                                    object="drag-module-small"
                                                    style="border-top-right-radius: 6px; border-top-left-radius: 6px; background-color: rgb(0, 210, 194);">
                                                    <tr>
                                                            ...
                                                            <table width="300" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" width="100%"
                                                                        style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 27px; color: rgb(255, 255, 255); line-height: 35px; font-weight: 400;"
                                                                        class="fullCenter">
                                                                        Se acaba de publicar una nueva nota
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td width="100%" valign="middle" align="center">
                                                            ...
                                                            <table width="350" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" width="100%"
                                                                        style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 40px; color: rgb(63, 67, 69); line-height: 42px; font-weight: 700;"
                                                                        class="fullCenter">
                                                                        {{ $dataGrupo->name }}
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" width="100%" class="icon18"
                                                                        ...
                                                                        <table width="220" border="0"
                                                                            ...
                                                                            align="center"
                                                                            style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; border: 1px solid #ebeef5;"
                                                                            class="fullCenter">
                                                                            <tr>

                                                                                <td width="10" height="44"
                                                                                    class="erase"></td>
                                                                                <td width="151" height="44"
                                                                                    style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 15px; color: #00d2c2; line-height: 22px; font-weight: 700;">
                                                                                    {{ $userPublic->name }}</td>
                                                                                <td width="10" height="44"
                                                                                    class="erase"></td>
                                                                            </tr>
                                                    ...
                                                    <tr>
                                                        <td width="100%" valign="middle" align="center">
                                                            ...
                                                            <table width="350" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" width="100%"
                                                                        style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 40px; color: rgb(63, 67, 69); line-height: 42px; font-weight: 400;"
                                                                        class="fullCenter">
                                                                        {{ $dataNote->title }}
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <tr>
                                                        <td width="100%" valign="middle" align="center">
                                                            ...
                                                            <table width="330" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" width="100%"
                                                                        style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 13px; color: rgb(142, 145, 151); line-height: 24px; font-weight: 400;"
                                                                        class="fullCenter">
                                                                        Contiene {{ $dataImage}} Imágenes la Nota
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                    ...
                                    <table width="352" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td valign="middle" width="100%"
                                                style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: rgb(142, 145, 151); font-size: 12px; font-weight: 400; line-height: 18px; font-style: italic;"
                                                class="fullCenter">
                                                <i>Reto Backend</i><br> Marco Antonio Sotomayor Lopez
                                            </td>
                                        </tr>
                                    </table>
    ...
    <!-- Notification 4  -->
    <div style="display: none" id="element_05771359161008149"></div><!-- End Notification 4 -->

    <!-- Notification 5  -->
    <div style="display: none" id="element_09244545821566135"></div><!-- End Notification 5 -->

    <!-- Notification 6  -->
    <div style="display: none" id="element_015614237962290645"></div><!-- End Notification 6 -->
